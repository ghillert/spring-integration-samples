...
CREATE PROCEDURE INSERT_COFFEE( IN id INTEGER, IN name VARCHAR(200), IN description VARCHAR(200)) PARAMETER STYLE JAVA LANGUAGE JAVA EXTERNAL NAME 'org.springframework.integration.jdbc.storedproc.derby.DerbyStoredProcedures.insertCoffee';
