...
public final class Main {
    ...
    public static void main(final String... args) {
        ...
        System.out.print("Please listenter 'list' and press <enter> to get a list of coffees.");
        ...
        while (!scanner.hasNext("q")) {
        	...
        	if ("list".equalsIgnoreCase(input)) {
        		...
        		String[] coffeeBeverageFragments = fragments[1].split(",");
        				
        		CoffeeBeverage coffeeBeverage = new CoffeeBeverage(Integer.valueOf(coffeeBeverageFragments[0]), 
        				                                           coffeeBeverageFragments[1], 
        				                                           coffeeBeverageFragments[2]);
        		
        		LOGGER.info("Inserting coffee beverage information {}.", coffeeBeverage);
